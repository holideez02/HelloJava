...
{"id":10,"first_name":"Norris","last_name":"Rey","email":"nrey9@reddit.com","gender":"Male","salary":5130}]`;
	...
	function makeTr(obj) {
		...
		let txt2 = document.createTextNode(str2);
		let txt3 = document.createTextNode(str3);
		let txt4 = document.createTextNode(str4);

		tdTag.appendChild(txt);
		tdTag2.appendChild(txt2);
		tdTag3.appendChild(txt3);
		tdTag4.appendChild(txt4);
