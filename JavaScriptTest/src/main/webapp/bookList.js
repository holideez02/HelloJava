...
function domLoadedFunc() {
    ...
    function makeList(ary = []) { //목록 출력
        ...
        //////////////////////////삭제//////////////////////////
        //document.querySelector('button[type=button]').addEventListener('click', delFunc);
        document.querySelector('#delete').addEventListener('click', delFunc);

        function delFunc(){
            console.log('삭제실행')
            let bookid = this.parentElement.parentElement.getAttribute('bookCode');
            let data = bookid;
            ...
            //this.parentElement.parentElement.remove(); :화면에서 삭제..
