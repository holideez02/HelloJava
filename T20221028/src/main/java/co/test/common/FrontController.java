...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		map.put("/addBookForm.do", new AddBookFormControl());//등록
		map.put("/addBook.do", new AddBookControl());

		map.put("/searchBookForm.do", new SearchBookFormControl());//검색
		map.put("/searchBook.do", new SearchBookControl());

		map.put("/modifyBookForm.do", new ModifyBookFormControl());//수정검색
		map.put("/modifyBook.do", new ModifyBookControl());

		map.put("/removeBookForm.do", new RemoveBookFormControl());//삭제검색
		map.put("/removeBook.do", new RemoveBookControl());

		map.put("/listBook.do", new ListBookControl());//도서목록
	}
